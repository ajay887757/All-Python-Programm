...
words_for_Hun=['HUNDRED','ONE HUNDRED','TWO HUNDRED','THREE HUNDRED','FOUR HUNDRED','FIVE HUNDRED','SIX HUNDRED','SEVEN HUNDRED','EIGHT HUNDRED','NINE HUNDRED']
...
if n==0:
    ...
    output=words_for_Hun[n//100]+" "+words_for_tens[(n%100)//10]+" "+words_upto_19[(n%100)%10]
else:
